...
tableName: 'places',
  attributes: {
    id: {type: 'number', autoIncrement: true, columnName: 'place_id', unique: true,},
    ...
    place_type_id: {type: 'number', columnName: 'place_type_id', required: true,},
    description: {type: 'string', columnName: 'description', required: true },
    narrative_id: {type: 'number', columnName: 'narrative_id', required: true },
